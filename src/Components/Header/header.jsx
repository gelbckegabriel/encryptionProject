                  ...
                  <Link to="/encryptlist" style={{ textDecoration: "none" }}>
                    <span className="nav-link text-white">
                      <svg
                        ...
                        height="16"
                        fill="currentColor"
                        className="bi bi-lock-fill d-block mx-auto mb-1"
                        viewBox="0 0 16 16"
                      >
                ...
                <li className={Styles.button}>
                  ...
                  >
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="bi bi-github d-block mx-auto mb-1"
                      viewBox="0 0 16 16"
                    >
                ...
                <li className={Styles.button}>
                  ...
                  >
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="bi bi-linkedin d-block mx-auto mb-1"
                      viewBox="0 0 16 16"
                    >
                ...
                <li className={Styles.button}>
                  <span href="#" className="nav-link text-white">
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="bi bi-globe-americas d-block mx-auto mb-1"
                      viewBox="0 0 16 16"
                    >
